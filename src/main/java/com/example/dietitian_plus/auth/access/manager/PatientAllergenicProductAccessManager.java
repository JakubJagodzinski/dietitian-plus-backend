...
public class PatientAllergenicProductAccessManager {

    private final SecurityUtils securityUtils;

    public void checkCanAccessPatientAllergenicProducts(Patient patient) throws AccessDeniedException {
    ...
    public void checkCanAssignAllergenicProductToPatient(UUID patientId) throws AccessDeniedException {
        UUID currentUserId = securityUtils.getCurrentUserId();
        boolean isAdmin = securityUtils.isAdmin();
    ...
    public void checkCanUnassignAllergenicProductFromPatient(UUID patientId) throws AccessDeniedException {
        UUID currentUserId = securityUtils.getCurrentUserId();
        boolean isAdmin = securityUtils.isAdmin();
        boolean isPatientOwner = patientId.equals(currentUserId);
