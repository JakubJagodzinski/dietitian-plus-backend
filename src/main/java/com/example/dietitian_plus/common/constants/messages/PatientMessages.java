...
public class PatientMessages {
    ...
    public static final String PATIENT_QUESTIONNAIRE_FILLED_SUCCESSFULLY = "Patient questionnaire filled successfully";
    public static final String BIRTHDATE_CANNOT_BE_NULL = "Birthdate cannot be null";
    public static final String HEIGHT_CANNOT_BE_NULL = "Height cannot be null";
    public static final String WEIGHT_CANNOT_BE_NULL = "Weight cannot be null";
